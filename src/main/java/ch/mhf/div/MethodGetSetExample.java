...
public class MethodGetSetExample
{
    ...
    //Konstruktor
    public MethodGetSetExample(String name, String waehrung, int einwohnerzahl)
    {
        this.name = name;
    ...
    {
        MethodGetSetExample myLand = new MethodGetSetExample("Schweiz","CHF",8000000);
        myLand.ausgabe();								//output Das Land Schweiz hat die Währung CHF und 8000000 Einwohner.

        MethodGetSetExample myLand2 = new MethodGetSetExample("England","Pfund",10);
