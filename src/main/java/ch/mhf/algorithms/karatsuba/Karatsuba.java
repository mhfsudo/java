...
public class Karatsuba
{
    ...
    {
        System.out.println(performeKaratsuba(200, 200));
        System.out.println(performeKaratsuba(12345, 6789));
        System.out.println(performeKaratsuba(2358925, 1259174));
    }
}
